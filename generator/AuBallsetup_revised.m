function [a, dfstack2, Q ,cmapidx,amask,translations] = AuBallsetup_revised(Dx,Dy,flag,imageFlag,sizeImg,sizeProb,alpha,iniamask)
%
...
w = fftshift(rr>=r1 & rr <= r2); % ps must fftshift
if exist('iniamask','var')
...
amask2=ifft2(fftshift(fft2(amask)).*exp(1j*factor*alpha)); %dist to center - an elapsing zero now
